...
module.exports.generate = function (input, options, jar, callback) {
    ...
    var child = exec(o, options.include, jar, callback)
...
function exec(argv, cwd, jar, callback) {
    ...
    var task = execWithSpawn(argv, cwd, jar, callback)
...
function execWithSpawn (argv, cwd, jar, cb) {
    cwd = cwd || process.cwd()
    var opts = [
